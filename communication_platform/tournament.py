...
class Tournament:
    ...
    def get_scoreboard(self):
        ...
        if cases == 4:
            ...
            string_size4 = max(len("" + padding2 + "|---" + opponent05 + padding8 + "|"),
                               (len("" + padding6 + "|---" + opponent06 + padding9 + "|"))) - 1
            padding4 = "".ljust(string_size4, ' ')
        ...
        if cases == 7:
            ...
            padding4 = "".ljust(string_size4, ' ')
            string_size5 = max(len(opponent03), len(opponent04), len(opponent05), len(opponent06), len(opponent07),
                               len(opponent08)) - len(opponent03)
            padding5 = "".ljust(string_size5, '-')
            string_size6 = max(len(opponent03), len(opponent04), len(opponent05), len(opponent06), len(opponent07),
                               len(opponent08)) - len(opponent04)
            padding6 = "".ljust(string_size6, '-')
            string_size7 = max(len(opponent03), len(opponent04), len(opponent05), len(opponent06), len(opponent07),
                               len(opponent08)) - len(opponent05)
            padding7 = "".ljust(string_size7, '-')
            string_size8 = max(len(opponent03), len(opponent04), len(opponent05), len(opponent06), len(opponent07),
                               len(opponent08)) - len(opponent06)
            padding8 = "".ljust(string_size8, '-')
            string_size9 = max(len(opponent03), len(opponent04), len(opponent05), len(opponent06), len(opponent07),
                               len(opponent08)) - len(opponent07)
            padding9 = "".ljust(string_size9, '-')
            string_size10 = max(len(opponent03), len(opponent04), len(opponent05), len(opponent06), len(opponent07),
                                len(opponent08)) - len(opponent08)
            padding10 = "".ljust(string_size10, '-')
        ...
        if cases == 8:
            ...
            first_game = [opponent01, opponent02, opponent03, opponent04, opponent05, opponent06, opponent07,
                          opponent08]
            max_string = len(max(first_game, key=len))
            string_size1 = len(opponent01)
            padding1 = "".ljust(int(max_string - string_size1), '-')
