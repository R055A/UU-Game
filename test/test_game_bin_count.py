...
class TestBinaryCharacteristicCount(TestCase):
    ...
    def test_top_row(self):
        ...
        """
        test = PlayerAI(Game(), "PlayerTest")
        test.game.board = [[None, '1000', '0001', '0101'],
                           [None, '0000', '0010', '0111'],
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([2, 1, 0, 1], test.characteristic_count('0110', 0, 0, 0, 1, 3))
    ...
    def test_second_row(self):
        ...
        test.game.board = [[None, '1000', '0001', '0101'],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([3, 1, 2, 2], test.characteristic_count('0110', 1, 0, 0, 1, 3))
    ...
    def test_third_row(self):
        ...
        test.game.board = [[None, '1000', '0001', '0101'],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([0, 1, 2, 0], test.characteristic_count('0110', 2, 1, 0, 1, 3))
    ...
    def test_fourth_row(self):
        ...
        test.game.board = [[None, '1000', '0001', '0101'],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', None]]
        self.assertEqual([3, 2, 2, 2], test.characteristic_count('0110', 3, 3, 0, 1, 3))
    ...
    def test_first_column(self):
        ...
        test.game.board = [[None, '1000', '0001', '0101'],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([1, 1, 0, 1], test.characteristic_count('0110', 1, 0, 1, 0, 3))
    ...
    def test_second_column(self):
        ...
        test.game.board = [[None, '1000', '0001', '0101'],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([2, 1, 1, 3], test.characteristic_count('0110', 2, 1, 1, 0, 3))
    ...
    def test_third_column(self):
        ...
        test.game.board = [[None, '1000', '0001', '0101'],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', None, '1110']]
        self.assertEqual([2, 1, 2, 1], test.characteristic_count('0110', 3, 2, 1, 0, 3))
    ...
    def test_fourth_column(self):
        ...
        """
        test = PlayerAI(Game(), "PlayerTest")
        test.game.board = [[None, '1000', '0001', None],
                           [None, '0000', '0010', '0111'],
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([1, 2, 3, 1], test.characteristic_count('0110', 0, 3, 1, 0, 3))
    ...
    def test_horizontal_one(self):
        ...
        test.game.board = [[None, '1000', '0001', None],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([2, 1, 1, 2], test.characteristic_count('0110', 0, 3, 1, -1, 3))
    ...
    def test_horizontal_two(self):
        ...
        test.game.board = [[None, '1000', '0001', None],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([1, 2, 2, 2], test.characteristic_count('0110', 0, 0, 1, 1, 3))
    ...
    def test_two_blocks(self):
        ...
        test.game.board = [[None, '1000', '0001', None],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([1, 1, 1, 1], test.characteristic_count('0110', 0, 0, 1, 1, 2))
    ...
    def test_one_block(self):
        ...
        test.game.board = [[None, '1000', '0001', None],
                           ...
                           ['1001', None, '1111', '1011'],
                           ['0100', '0110', '0011', '1110']]
        self.assertEqual([1, 0, 0, 1], test.characteristic_count('0110', 0, 0, 1, 1, 1))
